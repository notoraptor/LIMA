Les groupes ont été alignés avec le logiciel MUSCLE (MUSCLE v3.8.31 by Robert C. Edgar) à l'aide du script PHP align-groups.php.
Le script fonctionne à partir d’une liste de groupes et peut être lancé plusieurs fois en parallèle sur la même liste pour aligner rapidement tous les groupes.
Syntaxe d'utilisation du script:
	php align-groups.php groupList groupDir outDir partNumber partCount
		...
		groupDir : le dossier contenant les groupes. Chaque fichier doit être nommé comme suit : <nom du groupe>.fasta.
		...
		partCount : nombre de parties à considérer dans la liste (entier naturel non nul). Par exemple, si la liste contient 100 lignes et que partNumber = 2 et partCount = 5, alors l’exécution du script va aligner les groupes de la 2ème des 5 parties de la liste. Une partie contient 100/5 = 20 lignes (donc 20 groupes), donc la 2ème partie va de la 21ème à la 40ème ligne.
Génération de la groupList: dossier afterOrthoMCL:
...
Les fichiers alignment-*.err contiennent les sorties de MUSCLE (informations sur les itérations pour chaque groupe aligné).
