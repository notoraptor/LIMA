package lima.broadInstitute.gtf;
		...
		while((ligne = fichier.readLine()) != null) {
			...
			if(!ligne.isEmpty() && ligne.charAt(0) != '#') {
				...
				if(feature.equals("CDS") || feature.equals("exon")) {
					...
					/*
					Dans les fichiers GTF de BroadInstitute, seuls les transcript_id sont indiqués.
					On va donc supposer que les transcript_id et les protein_id sont identiques.
					*/
					if(proteinId == null) proteinId = transcriptId;
					if(geneId == null)
